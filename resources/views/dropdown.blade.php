          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a href="indexdropdown" class="btn btn-primary my-3">Data Customer</a>
                  <form class="form-horizontal" action="customerstore1" method="post">
                  @csrf
                     <div class="form-group">
                        <label for="nama">Nama :</label>
                           <input name="nama" class="form-control" style="width:250px"></input>
                        <label for="alamat">Alamat :</label>
                           <input name="alamat" class="form-control" style="width:250px"></input>
